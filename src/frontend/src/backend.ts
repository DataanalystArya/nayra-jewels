...
export class Backend implements backendInterface {
    ...
    async addProduct(arg0: string, arg1: string, arg2: string, arg3: bigint, arg4: boolean, arg5: boolean, arg6: string, arg7: string): Promise<bigint> {
    ...
    async bookBridalAppointment(arg0: string, arg1: string, arg2: string, arg3: string, arg4: string, arg5: string, arg6: string): Promise<bigint> {
        if (this.processError) {
            try {
                const result = await this.actor.bookBridalAppointment(arg0, arg1, arg2, arg3, arg4, arg5, arg6);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getAllAppointments(): Promise<Array<BridalAppointment>> {
        if (this.processError) {
            try {
